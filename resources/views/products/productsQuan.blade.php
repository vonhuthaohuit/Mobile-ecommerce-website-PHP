<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center p-2 mt-2" data-aos="fade-up">
        <a href="{{ route('products.productsByType', ['tenloai' => 'Quần Short']) }}" class="title-category">Quần
            Short</a>
        <a href="{{ route('products.productsByType', ['tenloai' => 'Quần Short']) }}" class="category-link-all">Xem các
            sản phẩm khác</a>
    </div>
    <div class="row mt-4 mb-2 d-flex justify-content-between">
        <div class="col-lg-6" data-aos="fade-up">
            <a href="/allProducts"><img src="../../images/Rhythm5.jpg" alt="" class="w-100 mb-4"></a>
        </div>
        <div class="col-lg-6 row float-end">
