<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center p-2 mt-2" data-aos="fade-up">
        <a href="{{ route('products.productsByType', ['tenloai' => 'Áo Sơ Mi']) }}" class="title-category">Áo Sơ Mi</a>
        <a href="{{ route('products.productsByType', ['tenloai' => 'Áo Sơ Mi']) }}" class="category-link-all">Xem các sản
            phẩm khác</a>
    </div>
    <div class="row mt-4">
